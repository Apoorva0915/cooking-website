...
exports.homepage=async(req,res)=>{
    try{
        ...
        const food={latest,thai,american,chinese,spanish,mexican,indian};
...
// explore Random
   ...
   exports.submitRecipe=async(req,res)=>{
    ...
    //     const res=await Recipe.updateOne({Image:"Butter-chicken.jpg"},{Image:"./public/uploads/Butter-chicken.jpg"})
    //      res.n;   // no. documents matched
    //      res.nModified;  // no. documents modified
    //   }catch(err){
    //      console.log(err);
    //   }
    // }
